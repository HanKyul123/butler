...
<body>
 <div class="policy_wrap">
        ...
        <div class="t_policy">
            <div class="policy">
                <div class="tab"> 
                    <ul> 
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/app/policyView/policy3.jsp" class="tab_on">개인정보 처리방침</a>
                        </li>
                        <li>
            ...
            이용자의 개인정보에 대한 조회, 수정 또는 가입해지 등의 문의에 대한 원활한 의사소통을 위해 고객행복센터를 운영하고 있으며,
                                        ...
                                        <table class="p_table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>고객행복센터</td>
                                                    <td>1670-6250</td>
                                                    <td>privacy@butler.co.kr</td>
                                                    <td>Butler 어플리케이션 내 문의하기</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <p>회사는 서비스 이용과정에서 정보주체에게 최적화된 맞춤형 서비스 및 혜택, 온라인 맞춤형 광고 등을 제공하기 위하여 행태정보를 수집·이용하고 있습니다.<br><br>
                                            ...
                                            <table class="p_table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>이용자 피해구제 방법</th>
                                                        <td>고객행복센터 / 1670-6250 / privacy@butler.co.kr</td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
<script src="${pageContext.request.contextPath}/js/policy3.js"></script>
